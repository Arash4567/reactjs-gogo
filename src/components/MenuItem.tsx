    ...
    <React.Fragment>
      <BrowserRouter>
        {menu.url === selectedPage ?
          ...
          :
          <NavLink to={menu.url} onClick={() => setSelectedPage(menu.url)} className="relative flex items-center h-10 w-full hover:bg-yellow-500/10 py-7 cursor-pointer transition-colors duration-300">
